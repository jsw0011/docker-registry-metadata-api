...
// ContextValidate validates this conflict response based on context it is used
func (m *ConflictResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
